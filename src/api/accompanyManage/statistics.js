...
export function listAccompanyManage(query) {
  return request({
    url: '/accompanyManage/statistics/list',
    method: 'post',
    data: query
  })
}
// 查询陪餐管理列表
export function listStatisticsDetail(query) {
    return request({
      url: '/accompanyManage/statistics/detailList',
      method: 'post',
      data: query
    })
  }
...
export function countAccompanyManage(query) {
  return request({
    url: '/accompanyManage/statistics/count',
    method: 'post',
    data: query
  })
}
...
export function getAccompanyManage(id) {
  return request({
    url: '/accompanyManage/statistics/' + id,
    method: 'get'
  })
}
...
export function addAccompanyManage(data) {
  return request({
    url: '/accompanyManage/statistics',
    method: 'post',
    data: data
  })
}
