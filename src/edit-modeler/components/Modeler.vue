<template>
  <div>
    <el-container :style="'height:' + height + 'px'">
      <el-aside width="70%" style="border: 1px solid #DCDFE6;margin-bottom: 0;" >
        ...
        <div ref="canvas" style="width: 100%;height: 100%;overflow-y: auto">
        </div>
      </el-aside>
      <el-main style="border: 1px solid #DCDFE6;background-color:#FAFAFA">
        <el-form label-width="auto" size="mini" label-position="top">
          <!-- 动态显示属性面板 -->
          <div id="js-properties-panel" style="width: 100%;height: 100%;overflow-y: auto"></div>
...
import request from '@/views/activitiModel/js/request';
