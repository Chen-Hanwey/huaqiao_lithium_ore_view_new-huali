<template>
  <div class="app-container">
        ...
        <div class="btn-container">
          <el-form-item>
            ...
            <el-button type="primary" plain icon="el-icon-plus" size="mini" @click="handleAdd"
                       v-hasPermi="['inOutWareHouse:purchaseLocationOut:add']">新增
            </el-button>
            <el-button type="warning" plain icon="el-icon-download" size="mini" @click="handleExport"
                       v-hasPermi="['inOutWareHouse:purchaseLocationOut:export']">导出
            </el-button>
            <el-button type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple" @click="handleDelete"
                    v-hasPermi="['inOutWareHouse:purchaseLocationOut:remove']"
            >删除</el-button>
          </el-form-item>
        </div>
      </div>
      ...
      <el-table-column label="操作" align="left" class-name="small-padding fixed-width" width="180">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['inOutWareHouse:purchaseLocationOut:query']"
          >详情</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['inOutWareHouse:purchaseLocationOut:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
    ...
    <purchaseLocationInventoryDialog ref="record_dialog" @callBack="callBack"></purchaseLocationInventoryDialog>
  </div>
</template>
