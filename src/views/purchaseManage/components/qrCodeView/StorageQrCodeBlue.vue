    ...
    <div>
        ...
        <div >
          ...
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">溯源信息</div>
            <el-row>
              <el-col :span="24">
        ...
        <div >
          ...
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">商品种植情况</div>
            <el-row>
              <el-col :span="24">
        ...
        <div >
          ...
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">申请采购人信息</div>
            <el-row>
              <el-col :span="24">
        ...
        <div >
          ...
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">采购信息</div>
            <el-row>
              <el-col :span="24">
...
<!--              </el-col>-->
        ...
        <div >
          ...
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">供应商信息</div>
            <el-row>
              <el-col :span="24">
        ...
        <div v-if="form.foodInspection">
          <!-- <div class="sub-title">
            <div class="sub-title-name">食材检查</div>
          </div> -->
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">食材检查</div>
            <el-row>
              <el-col :span="24">
              ...
              <el-col :span="24">
                <el-form-item label="快检图片：" prop="quickCheckPicture" class="custom-form-item">
                  ...
                  <el-image
                            ...
                            style="width: 200px;height: 200px;margin-right: 15px" fit="scale-down"
                            :preview-src-list="[getUrl(form.foodInspection.quickCheckPicture)]"
                  >
                    <div slot="error" class="image-slot" style="text-align: center">
                      <i class="el-icon-picture-outline" style="color: #999;line-height: 200px;user-select: none">
                        加载失败</i>
        ...
        <div >
          ...
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">企业入库信息</div>
            <el-row>
              <el-col :span="24">
        ...
        <div v-if="form.outLibrary">
          <!-- <div class="sub-title">
            <div class="sub-title-name">出库信息</div>
          </div> -->
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">企业出库信息</div>
            <el-row>
              <el-col :span="24">
        ...
        <div v-if="form.locationStorage">
          <!-- <div class="sub-title">
            <div class="sub-title-name">经营场所入库信息</div>
          </div> -->
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">经营场所入库信息</div>
            <el-row>
              <el-col :span="24">
                <el-form-item label="入库人：" prop="warehouseKeeper" class="custom-form-item">
        ...
        <div v-if="form.locationOutLibrary">
          <!-- <div class="sub-title">
            <div class="sub-title-name">经营场所出库信息</div>
          </div> -->
          <div class=" content_module">
            <div class="content_module_title" style="margin-bottom: 10px;">经营场所出库信息</div>
            <el-row>
              <el-col :span="24">
                <el-form-item label="出库人：" prop="outgoingPeople" class="custom-form-item">
