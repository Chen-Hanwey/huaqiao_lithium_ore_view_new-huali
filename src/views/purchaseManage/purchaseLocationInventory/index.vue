        ...
        <div class="btn-container">
          <el-form-item>
            ...
            <el-button type="primary" icon="el-icon-download" size="mini" @click="handleExport"
                       v-hasPermi="['purchaseInventory:purchaseLocationInventory:export']">导出
            </el-button>
      ...
      <el-table-column label="操作" align="left" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['purchaseInventory:purchaseLocationInventory:query']"
          >详情</el-button>
          <!-- <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['purchaseInventory:purchaseLocationInventory:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['purchaseInventory:purchaseLocationInventory:remove']"
          >删除</el-button> -->
        </template>
      </el-table-column>
    </el-table>
