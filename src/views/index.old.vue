  ...
  <div class="dashboard-editor-container">
    ...
    <el-dialog :visible.sync="UpgradeLogOpen" style=";margin-top: 150px" :close-on-click-modal="false"
      ...
      <div class="title">
        ...
        <span
          style="word-break:normal; width:auto; display:block; white-space:pre-wrap; word-wrap : break-word ; overflow: hidden ;">{{ NerUpgradeLog.upgradeContent }}</span>
      </div>
    ...
    <el-row :gutter="12">
      ...
      <el-col :span="9">
        <div class="card_shadow">
          <div class="card_title_index"><img class="icon" src="../assets/images/home/我的待办.png"><span>我的待办</span></div>
          <div class="card_content event-box">
            <router-link to="/Home/todoList?wfOrderType=1">
            <div class="event-box-item  bg-1"
                 v-if="userType == '00' || userType == '01'">
              <div class="event-box-item-image">
                <img  src="@/assets/images/home/1-1.svg" style="width: 50px;">
              </div>
              <div class="event-box-item-content">
                <div class="num-tip">{{ todoTypeNum[1] || 0 }}</div>
                <div class="num-tip1">经营主体</div>
              </div>
            </div>
            </router-link>
            <router-link to="/Home/todoList?wfOrderType=2">
              <div class="event-box-item ml-20 bg-2" v-if="userType == '00' || userType == '01'">
                <div class="event-box-item-image">
                  <img  src="@/assets/images/home/2-2.svg" style="width: 50px;">
                </div>
                <div class="event-box-item-content">
                  <div class="num-tip">{{ todoTypeNum[2] || 0 }}</div>
                  <div class="num-tip1">企业资质</div>
                </div>
              </div>
            </router-link>
            <router-link to="/Home/todoList?wfOrderType=3">
            <div class="event-box-item   bg-3" @click="$router.push('/Home/todoList?wfOrderType=3')">
              <div class="event-box-item-image">
                <img  src="@/assets/images/home/3-3.svg" style="width: 50px;">
              </div>
              <div class="event-box-item-content">
                <div class="num-tip">{{ todoTypeNum[3] || 0 }}</div>
                <div class="num-tip1">食安自查</div>
              </div>
            </div>
            </router-link>
            <router-link to="/Home/todoList?wfOrderType=6">
            <div class="event-box-item ml-20 bg-4" >
              <div class="event-box-item-image">
                <img  src="@/assets/images/home/4-4.svg" style="width: 50px;">
              </div>
              <div class="event-box-item-content">
                <div class="num-tip">{{ todoTypeNum[6] || 0 }}</div>
                <div class="num-tip1">食安监督</div>
              </div>
            </div>
            </router-link>
            <router-link to="/Home/todoList?wfOrderType=4">
            <div class="event-box-item  bg-5" >
              <div class="event-box-item-image">
                <img  src="@/assets/images/home/5-5.svg" style="width: 50px;">
              </div>
              <div class="event-box-item-content">
                <div class="num-tip">{{ todoTypeNum[4] || 0 }}</div>
                <div class="num-tip1">餐饮量化</div>
              </div>
            </div>
            </router-link>
            <router-link to="/Home/todoList?wfOrderType=5">
            <div class="event-box-item ml-20 bg-6" >
              <div class="event-box-item-image">
                <img  src="@/assets/images/home/6-6.svg" style="width: 50px;">
              </div>
              <div class="event-box-item-content">
                <div class="num-tip">{{ todoTypeNum[5] || 0 }}</div>
                <div class="num-tip1">信用评定</div>
              </div>
            </div>
            </router-link>
          </div>
      ...
      <el-col :span="7">
        <div class="card_shadow">
          ...
          <div class="card_content alarm-box-1">
            <router-link v-for="(item, index) in incidentSum"
                         :to="`/Video/aiAlarm/appear?type=${item.dictLabel}`">
    ...
    <el-row :gutter="12">
      ...
      <el-col :span="9">
        <div class="card_shadow">
          <div class="card_title_index"><img class="icon" src="../assets/images/home/我的已办.png"><span>我的已办</span></div>
          <div class="card_content finish-box">
            <!--            <done-table :content-height="'220'"></done-table>-->
      ...
      <el-col :span="7">
        <div class="card_shadow" style="overflow:hidden;">
...
export default {
  name: 'Index',
  components: {Notice,missingRecord},
  data() {
    return {
      ...
      incidentSum: [
        {
          dictLabel: "人员工装",
          iconUrl: require("../assets/images/home/ai/工装-1.png"),
          bgImage: require("../assets/images/home/ai/工装.png"),
        },
        {
          dictLabel: "人员工帽",
