<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px" style="margin-bottom: 5px;">
      ...
      <div class="toggle-container" ref="toggle-container" style="display: inline-block;">
        <div class="condition-item">
          <label class="condition-item-title">权限字符</label>
    ...
    <!-- 新增或修改角色配置对话框 -->
    <el-dialog :title="title" @open="openAcion" :visible.sync="open" class="_baseForm_big" :close-on-click-modal="false">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="角色名称" prop="roleName">
          <el-input v-model="form.roleName" placeholder="请输入角色名称" maxlength="32" show-word-limit/>
        </el-form-item>
        <el-form-item label="权限字符" prop="roleKey">
          <el-input v-model="form.roleKey" placeholder="请输入权限字符" maxlength="32" show-word-limit/>
        </el-form-item>
        <el-form-item label="角色顺序" prop="roleSort">
          <el-input-number v-model="form.roleSort" controls-position="right" style="width: 220px" :min="0" />
        </el-form-item>
    ...
    <!-- 分配角色数据权限对话框 -->
    <el-dialog :title="title" :visible.sync="openPartyScope" width="500px" class="customDialog" :close-on-click-modal="false">
      <el-form :model="partyForm" label-width="80px">
        <el-form-item label="角色名称">
          <el-input v-model="partyForm.roleName" :disabled="true" />
        </el-form-item>
        <el-form-item label="权限字符">
          <el-input v-model="partyForm.roleKey" :disabled="true" />
        </el-form-item>
        <el-form-item label="权限范围">
          <el-select v-model="partyForm.partyScope">
            <el-option
              v-for="item in partyScopeOptions"
              :key="item.value"
              :label="item.label"
              :value="item.value"
            ></el-option>
        ...
        <el-form-item label="数据权限" v-show="partyForm.partyScope == 2">
          <el-tree
      ...
      <div slot="footer" class="dialog-footer">
        <el-button type="primary" @click="submitPartyScope">确 定</el-button>
        <el-button @click="cancelPartyScope">取 消</el-button>
      </div>
    </el-dialog>
