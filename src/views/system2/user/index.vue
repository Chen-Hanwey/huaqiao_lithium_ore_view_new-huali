<template>
  <div class="app-container">
          ...
          <div class="con-container">
            ...
            <div class="btn-container">
              <el-form-item>
                ...
                <el-button type="danger" icon="el-icon-delete" plain size="mini" :disabled="multiple" @click="handleDelete"
    ...
    <!-- 新增或修改参数配置对话框 -->
    <el-dialog :title="title" :visible.sync="open" class="_baseForm_big" :close-on-click-modal="false">
