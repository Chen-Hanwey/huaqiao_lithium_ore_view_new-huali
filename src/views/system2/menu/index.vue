        ...
        <el-row>
          ...
          <el-col :span="24">
            <el-form-item label="菜单名称" prop="menuName">
              <el-input v-model="form.menuName" placeholder="请输入菜单名称" maxlength="32" show-word-limit/>
            </el-form-item>
          </el-col>
          <el-col :span="14">
          ...
          <el-col :span="14">
            <el-form-item v-if="form.menuType != 'F'" label="路由地址" prop="path">
              <el-input v-model="form.path" placeholder="请输入路由地址" maxlength="32" show-word-limit/>
            </el-form-item>
          </el-col>
          <el-col :span="10">
          ...
          <el-col :span="24">
            <el-form-item v-if="form.menuType != 'M'" label="权限标识">
              <el-input v-model="form.perms" placeholder="请权限标识" maxlength="100" show-word-limit/>
            </el-form-item>
          </el-col>
          <el-col :span="24">
