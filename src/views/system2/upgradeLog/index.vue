    ...
    <el-dialog :visible.sync="open" fullscreen :close-on-click-modal="false" class="customForm" @opened="openDialog">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="系统名称" prop="sysName">
          <el-input v-model="form.sysName" placeholder="请输入系统名称" :readonly="readOnly" style="width: 100%" maxlength="40" show-word-limit/>
        </el-form-item>
        ...
        <el-form-item label="系统版本" prop="sysVersion">
          <el-input v-model="form.sysVersion" placeholder="请输入系统版本" :readonly="readOnly" style="width: 100%" maxlength="64" show-word-limit/>
        </el-form-item>
