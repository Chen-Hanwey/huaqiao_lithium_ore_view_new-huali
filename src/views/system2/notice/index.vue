  ...
  <div class="app-container">
    ...
    <el-table ref="table" :height="tableHeight" v-loading="loading" :data="noticeList" @sort-change="changeTableSort" @selection-change="handleSelectionChange">
      ...
      <el-table-column
        ...
        align="left"
        prop="noticeTitle"
        minWidth="300" :show-overflow-tooltip="true" sortable :render-header="(h,obj) => renderHeader(h,obj)"
      />
      <el-table-column
        label="公告类型"
        align="left"
      ...
      <el-table-column label="创建者" align="left" prop="nickName" sortable :render-header="(h,obj) => renderHeader(h,obj)"/>
      <el-table-column label="创建时间" align="left" width="180" prop="createTime" sortable :render-header="(h,obj) => renderHeader(h,obj)">
        <template slot-scope="scope">
    ...
    <!-- 新增或修改公告对话框 -->
    <el-dialog :visible.sync="open" fullscreen :close-on-click-modal="false" class="customForm" @opened="openDialog" :before-close="beforeCloseDialog">
      <div slot="title">
