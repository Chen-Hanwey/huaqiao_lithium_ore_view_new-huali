...
export default {
   ...
   * time 回放时间 暂时废弃
   */
  props: ["index", "type", "code", "time", "zoom"],
  data () {
    return {
      sizes: {
  ...
  watch: {
    ...
    zoom (value) {
      window.console.log("---")
      window.console.log(value + ":缩放比例")
      this.swfHeight = document.getElementById("div33").offsetHeight * value;
      this.swfWidth = document.getElementById("div33").offsetWidth * value;
    }
  },
  methods: {
    getInitParams () {
  ...
  mounted () {
    ...
    this.swfHeight = document.getElementById("playWnd").offsetHeight;
    this.swfWidth = document.getElementById("playWnd").offsetWidth;
    // this.swfWidth = this.$parent.$el.offsetWidth - 20

    // this.swfHeight = this.$parent.$el.offsetHeight - 100
    // this.swfWidth = this.$parent.$el.offsetWidth - 100

    window.console.log(document.getElementById("div33"))

    window.console.log(document.getElementById("div33").style.offsetWidth)
    window.console.log(document.getElementById("div33").style.offsetHeight)

    // this.swfHeight = this.$parent.$refs.div33.offsetHeight / 1.5;
    // this.swfWidth = this.$parent.$refs.div33.offsetWidth / 1.5;
    // this.swfHeight = 200
    // this.swfWidth = 280


    this.swfHeight = document.getElementById("div33").offsetHeight * this.zoom;
    this.swfWidth = document.getElementById("div33").offsetWidth * this.zoom;
    ...
    $(window).resize(() => {
      if (this.oWebControl != null) {
        this.swfHeight = this.swfHeight * this.zoom;
        this.swfWidth = this.swfWidth * this.zoom;
