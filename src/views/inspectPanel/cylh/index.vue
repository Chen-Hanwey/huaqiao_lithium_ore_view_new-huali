<template>
  <div style="height: 100%">
    <el-table ref="table" style="height: 80%"  v-loading="loading" :data="cylhData" height="335" :row-style="{height: '42px'}" >
      ...
      <el-table-column
        ...
        style="height: 100%"
      />
      <el-table-column label="量化等级" align="left" prop="rectificationStatus" >
        <template slot-scope="scope">
