<template>
  <div style="height: 100%">
    <el-table ref="table" style="height: 80%"  v-loading="loading" :data="exerciseData" height="335" :row-style="{height: '42px'}">
...
export default {
  ...
  methods: {
    ...
    getList(operationId) {
      this.loading = true;
      listExerciseRecord({...this.queryParams,params:{operationId: operationId}}).then(res => {
