<template>
  ...
  <el-dialog title="导入表" :visible.sync="visible" width="800px" top="5vh">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px" style="margin-bottom: 5px">
      <div class="con-container">
        ...
        <div class="lab-container">
          ...
          <el-form-item label="" prop="tableComment" class="custom-el-form-item">
            <el-input
    ...
    <el-row>
      <el-table @row-click="clickRow" ref="table" v-loading="mloading" :data="dbTableList" @sort-change="changeImportTableSort" @selection-change="handleSelectionChange" height="260px">
        <el-table-column type="selection" width="50"></el-table-column>
        <el-table-column prop="tableName" label="表名称" sortable :render-header="renderHeader"></el-table-column>
        <el-table-column prop="tableComment" label="表描述" ></el-table-column>
        <el-table-column prop="createTime" label="创建时间" sortable :render-header="renderHeader"></el-table-column>
        <el-table-column prop="updateTime" label="更新时间" sortable :render-header="renderHeader"></el-table-column>
      </el-table>
      <pagination
        v-show="total>0"
        :total="total"
