<template>
  <div class="app-container">
    ...
    <el-table key="one" ref="table" v-loading="loading" @sort-change="changeTableSort" stripe
      ...
      <el-table-column label="当前环节处理人" align="left" prop="approveUser"  :render-header="renderHeader"/>
      <el-table-column label="处理状态" align="left" prop="wfOrderStatusCN"  :render-header="renderHeader"/>
      <el-table-column label="工单开始时间" align="left" prop="createTime"  :render-header="renderHeader">
      </el-table-column>
      <el-table-column label="到达当前环节时间" align="left" prop="updateTime" :render-header="renderHeader">
        <template slot-scope="scope">
