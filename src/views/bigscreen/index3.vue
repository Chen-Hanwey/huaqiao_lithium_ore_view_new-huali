  ...
  <div class="data-box-mark">
    ...
    <scale-box ref="scaleBox" id="main">
      <div class="data-box" id="datavBox">
        <header-box3 @screen="screen"></header-box3>
        <div class="main-content">
          ...
          <div class="center">
            <center-group-one  @showOperationDetail="showOperationDetail" :deptz="'商务局'"></center-group-one>
...
<script>
import headerBox3 from '@/views/bigscreen/child/headerBox3'
...
export default {
  ...
  methods: {
    ...
    showOperationDetail(id,enterpriseId){
      this.$refs.mapInspectPanel.open(id,enterpriseId);
    }
