...
import { getQualityScoreTrendComp } from '@/api/bigScreen/inspectPanel'
...
export default {
  ...
  methods: {
    initChart(datas) {
      ...
      const xAxis = ['一', '二', '三', '四', '五', '六', '七', '八', '九', '十', '十一', '十二']
     ...
     * 评分趋势
     */
    getQualityScoreTrendComp() {
      let that = this;
      getQualityScoreTrendComp().then(res => {
