    ...
    <scale-box ref="scaleBox" id="main">
      <div class="data-box" id="datavBox">
        ...
        <div class="main-content">
          ...
          <div class="center">
            <center-group-one  @showOperationDetail="showOperationDetail" :deptz="'市场监督管理局'"></center-group-one>
...
<script>
import headerBox from '@/views/bigscreen/child/headerBox'
...
export default {
  ...
  methods: {
    ...
    showOperationDetail(id){
      ...
      this.$refs.mapInspectPanel.getInfo();
    }
