import { listSupervisionUser, getUser, delUser, addUser, updateUser, exportUser, resetUserPwd, changeUserStatus, importTemplate } from "@/api/system/user";
...
/*        sex: [{
  ...
  methods: {
    ...
    // },
    getAllEnterpriseList(){
      listEnterpriseTreeWithDept("01").then(res=>{
        this.enterpriseList=res.data;
      })
    },
/*    getDistrictList(){
    ...
    getList() {
      ...
      listSupervisionUser(this.addDateRange(this.queryParams, this.dateRange)).then(response => {
    ...
    getRole() {
      getRoleByUserType("01").then(response => {
