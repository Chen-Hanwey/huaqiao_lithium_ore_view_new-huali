...
<!--        </div>-->
<!--        <div class="head-container" :style="{'height':treeHeight+'px', 'overflow': 'auto','background':' #ffffff'}">-->
...
<!--            <div class="condition-item">
            ...
            <div class="condition-item">
              <label class="condition-item-title">监管单位</label>
...
<!--          <el-table-column label="身份证号" align="left" min-width="110px" prop="idCard" :show-overflow-tooltip="true" sortable
          ...
          <el-table-column label="监管单位" align="left" prop="deptName"  :show-overflow-tooltip="false"/>
...
<!--          <el-col :span="12">
          ...
          <el-col :span="12">
            <el-form-item label="监管单位" prop="deptId">
              <treeselect v-model="form.deptId" :options="deptOptions" placeholder="请选择监管单位" style="height: 33px;"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
