...
<!--          <el-tree :style="treeStyle" :data="enterpriseListTree"  :expand-on-click-node="true"-->
...
<!--                <el-button type="primary" icon="el-icon-upload2" size="mini" @click="handleImport"
          ...
          <div class="toggle-container" ref="toggle-container" style="display:none;">
            <high-query :showDistrict="false" ref="highQuery" :show-operation="false"
            ></high-query>
          </div>
        </el-form>
...
<script>
    ...
    // import enterpriseUser from './user';
    //
    // export default {
    //   ...enterpriseUser
    // }
