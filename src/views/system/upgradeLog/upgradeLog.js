import { listUpgradeLog, getUpgradeLog, delUpgradeLog, addUpgradeLog, updateUpgradeLog, exportUpgradeLog, checkSysVersionAdd, checkSysVersionEdit,UpgradeLog } from "@/api/system/upgradeLog";
import $ from "jquery";
  ...
  methods: {
    ...
    getList() {
      ...
      listUpgradeLog(this.queryParams).then(response => {
        ...
        console.log(this.upgradeLogList)
    ...
    getFirst() {
      ...
      UpgradeLog(this.queryParams).then(response => {
        this.upgradeLog = response.rows[0];
        console.log(this.upgradeLog)
        this.total = response.total;
        this.loading = false;
      });
    },
