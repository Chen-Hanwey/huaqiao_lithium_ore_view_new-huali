...
<!--            <el-button type="primary" icon="el-icon-setting" size="mini" @click="conditionToggle">高级查询
            ...
            <el-button type="primary" icon="el-icon-plus" size="mini" @click="handleAdd"
                       v-hasPermi="['district:district:add']">新增
            </el-button>
            <el-button type="primary" icon="el-icon-download" size="mini" @click="handleExport"
                       v-hasPermi="['district:district:export']">导出
            </el-button>
      ...
      <div class="toggle-container" ref="toggle-container" style="display: none;">
        ...
        <!--<div class="condition-item">
            <label class="condition-item-title">行政号</label>
              <el-form-item label="" prop="cityCode">
                <el-input
                  v-model="queryParams.cityCode" class="query-param"
                  placeholder="请输入行政号"
                  clearable
                  size="small"
                  @keyup.enter.native="handleQuery"
...
<!--        <div class="condition-item">
            <label class="condition-item-title">级别</label>
              <el-form-item label="" prop="level">
                &lt;!&ndash;<el-input
                  v-model="queryParams.level" class="query-param"
                  placeholder="请输入级别"
                  clearable
                  size="small"
                  @keyup.enter.native="handleQuery"
        ...
        <!--<div class="condition-item">
            <label class="condition-item-title">经度</label>
              <el-form-item label="" prop="longitude">
                <el-input
                  v-model="queryParams.longitude" class="query-param"
                  placeholder="请输入经度"
                  clearable
                  size="small"
                  @keyup.enter.native="handleQuery"
        ...
        <div class="condition-item">
            <label class="condition-item-title">纬度</label>
              <el-form-item label="" prop="latitude">
                <el-input
                  v-model="queryParams.latitude" class="query-param"
                  placeholder="请输入纬度"
                  clearable
                  size="small"
                  @keyup.enter.native="handleQuery"
    ...
    <el-dialog :visible.sync="open"  :close-on-click-modal="false" class="customForm _baseForm_big" @opened="openDialog">
      ...
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="级别" prop="level">
          <el-select v-model="form.level" placeholder="请选择级别" clearable size="small" :disabled="true" class="customSelect">
            <el-option
              v-for="dict in districtTypeList"
              :key="dict.dictValue"
              :label="dict.dictLabel"
